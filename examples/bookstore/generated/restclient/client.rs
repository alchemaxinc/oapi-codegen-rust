...
#[path = "client/list_books.rs"]
mod list_books;
#[path = "client/create_book.rs"]
mod create_book;
#[path = "client/get_book.rs"]
mod get_book;
#[path = "client/upload_book_cover.rs"]
mod upload_book_cover;
#[path = "client/submit_review.rs"]
mod submit_review;
#[path = "client/get_health.rs"]
mod get_health;
