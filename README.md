...
The table below is generated from [`.github/openapi-versions.json`](.github/openapi-versions.json) by
`make update-versions`; edit that manifest (not the table) and re-run the target. New upstream releases are detected
weekly by the [`detect-openapi-release`](.github/workflows/detect-openapi-release.yml) workflow, which opens a tracking
issue, asks Copilot for a code-wide assessment, and appends the version here via a pull request.
